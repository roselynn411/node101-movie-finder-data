...
mock
  .onGet('http://www.omdbapi.com', { params: { i: 'tt3896198', apiKey: '5359f28' }})
  .replyOnce(withMovie(0))
	.onGet('http://www.omdbapi.com/', { params: { i: 'tt3896198', apiKey: '5359f28' }})
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com/?i=tt3896198&apikey=5359f28')
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com/?apikey=5359f28&i=tt3896198')
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com', { params: { t: 'baby driver', apiKey: '5359f28' }})
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/', { params: { t: 'baby driver', apiKey: '5359f28' }})
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/?t=baby%20driver&apikey=5359f28')
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/?apikey=5359f28&t=baby%20driver')
  .replyOnce(withMovie(1))
